        ...
        <div className="flex flex-wrap justify-between md:flex-nowrap md:gap-10">
          <div className="order-1 hidden w-full flex-col items-center justify-center md:order-none md:flex md:w-auto md:flex-row md:justify-start">
            ...
            <Menulist as={"div"} className="relative inline-block text-left">
              ...
              <MenuItems
                transition
                className="absolute z-10 mt-2 w-56 original-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black/5 transition focus:outline-none"
              >
                <div className="py-1">
                  {categories.map((category) => (
                    <MenuItem key={category.id}>
                      <Link
                        ...
                        className="block px-4 py-2 text-sm font-medium text-gray-900 hover:text-blue-500"
                      >
                        {category.title}
                      </Link>
                    </MenuItem>
          ...
          <div className="flex w-full items-center justify-between md:w-auto">
            ...
            <Button
              ...
              className="ml-auto bg-transparent rounded-md px-2 py-1 text-gray-500 focus:bg-transparent focus:text-blue-500 focus:outine-none md:hidden"
            >
              {menuOpen && <X />}

              {!menuOpen && <Menu color="#178e96" />}
            </Button>
          </div>
          {menuOpen && (
